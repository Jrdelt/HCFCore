...
class RuneShopMenuListenerTest {
    ...
    @BeforeEach void setup(){
        ...
        messages=new Messages(plugin,new UserManager(plugin,null));messages.load();
        BackpackManager backpackManager=new BackpackManager(plugin,messages);backpackManager.load();
        listener=new RuneShopMenuListener(manager,null,backpackManager,messages);
