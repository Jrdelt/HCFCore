...
public final class TagSearchMenu {
    ...
    static String readQuery(Player player, Messages messages, org.bukkit.inventory.InventoryView view, Inventory inventory) {
        String text;
        if (view instanceof AnvilView anvilView) {
            ...
            // MockBukkit currently exposes a generic InventoryView for anvils.
            // Paper uses the non-deprecated AnvilView path above.
