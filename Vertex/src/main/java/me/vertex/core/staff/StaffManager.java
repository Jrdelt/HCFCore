...
public final class StaffManager {
     ...
     * player: viewers with {@code vertex.staff.vanish} can still see the
    ...
    public void applyVanishState(Player player) {
        ...
        for (Player viewer : Bukkit.getOnlinePlayers()) {
            ...
            if (hidden && !viewer.hasPermission("vertex.staff.vanish")) {
    ...
    public void applyVanishToJoiningPlayer(Player viewer) {
        if (viewer.hasPermission("vertex.staff.vanish")) {
            return;
        }
